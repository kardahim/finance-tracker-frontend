...
const incomeId = +router.currentRoute.value.params.id
await incomeStore.getIncomeById(incomeId)
...
if (incomeStore.singleIncome.userId !== authStore.user.id) {
  router.push('/')
}

function onSubmit(values: any) {
  incomeStore.editIncome(incomeId, values)
}
</script>
  ...
  >
    ...
    <div class="income__item">
      ...
      <Field
        ...
        :value="incomeStore.singleIncome.name"
    ...
    <div class="income__item">
      ...
      <Field
        ...
        type="number"
        class="income__item__input"
        :value="incomeStore.singleIncome.amount"
    ...
    <div class="income__item">
      ...
      <Field
        ...
        name="date"
        type="date"
        :value="new Date(incomeStore.singleIncome.date!).toISOString().substr(0, 10)"
        class="income__item__input"
    ...
    <div class="income__item">
      ...
      <Field
        ...
        name="sourceId"
        class="income__item__input"
        :value="incomeStore.singleIncome.incomeSource.id"
    ...
    <div class="income__item income__item--flex">
      <button class="income__item__button" :disabled="isSubmitting">Edit</button>
